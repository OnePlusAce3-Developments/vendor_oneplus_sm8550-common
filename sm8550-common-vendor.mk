...
PRODUCT_COPY_FILES += \
    ...
    vendor/oneplus/sm8550-common/proprietary/odm/etc/libdapparamstorage_v3_6_etc.so:$(TARGET_COPY_OUT_ODM)/etc/libdapparamstorage_v3_6_etc.so \
    vendor/oneplus/sm8550-common/proprietary/odm/etc/libdeccfg_v3_6_etc.so:$(TARGET_COPY_OUT_ODM)/etc/libdeccfg_v3_6_etc.so \
    vendor/oneplus/sm8550-common/proprietary/odm/etc/libdlbdsservice_v3_6_etc.so:$(TARGET_COPY_OUT_ODM)/etc/libdlbdsservice_v3_6_etc.so \
    vendor/oneplus/sm8550-common/proprietary/odm/etc/libqtigef_etc.so:$(TARGET_COPY_OUT_ODM)/etc/libqtigef_etc.so \
    vendor/oneplus/sm8550-common/proprietary/odm/etc/libstagefright_soft_ddpdec_etc.so:$(TARGET_COPY_OUT_ODM)/etc/libstagefright_soft_ddpdec_etc.so \
    vendor/oneplus/sm8550-common/proprietary/odm/etc/libstagefrightdolby_etc.so:$(TARGET_COPY_OUT_ODM)/etc/libstagefrightdolby_etc.so \
    ...
    vendor/oneplus/sm8550-common/proprietary/odm/etc/soundfx/libhwdap_v3_6_etc.so:$(TARGET_COPY_OUT_ODM)/etc/soundfx/libhwdap_v3_6_etc.so \
    vendor/oneplus/sm8550-common/proprietary/odm/etc/soundfx/libswdap_v3_6_etc.so:$(TARGET_COPY_OUT_ODM)/etc/soundfx/libswdap_v3_6_etc.so \
    vendor/oneplus/sm8550-common/proprietary/odm/etc/vendor.dolby_v3_6.hardware.dms360@2.0-impl_etc.so:$(TARGET_COPY_OUT_ODM)/etc/vendor.dolby_v3_6.hardware.dms360@2.0-impl_etc.so \
    vendor/oneplus/sm8550-common/proprietary/odm/etc/vendor.dolby_v3_6.hardware.dms360@2.0_etc.so:$(TARGET_COPY_OUT_ODM)/etc/vendor.dolby_v3_6.hardware.dms360@2.0_etc.so \
